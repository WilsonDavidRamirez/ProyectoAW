        ...
        <aside>
            ...
            <nav>
                <ul class="menu">
                    ...
                    <li>
                        <button id="deportivos" class="boton-menu boton-categoria"><i class="bi bi-hand-index-thumb"></i>
                            Deportivos</button>
                    </li>
                    <li>
                        <button id="formales" class="boton-menu boton-categoria"><i
                                class="bi bi-hand-index-thumb"></i> Formales</button>
                    </li>
                    <li>
